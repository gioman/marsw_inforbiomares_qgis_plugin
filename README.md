...
|         |                                                                                                                                                                                                                                                                                                                              |
+---------+----------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 601     | Serviço de transformação do sistema de referência temporal     | Serviço que permite modificar os valores das ocorrências temporais de um sistema de referência temporal para outro                                                                                                                                          |
