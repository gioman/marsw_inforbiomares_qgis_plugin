...
O “
**Plugin para criação e edição de metadados segundo o perfil SNIMar**
”
é o "
*porting*
...
foi desenvolvido no âmbito do Projeto SNIMar com o objetivo de ser a ferramenta destinada à criação de metadados em conformidade com o Perfil de Metadados SNIMar. O Editor consiste num
*plugin*
para a aplicação QGIS®, permitindo que a criação de metadados seja feita em paralelo e em simultâneo com a criação e edição de Conjuntos de Dados Geográficos (CDG).
